...
extern void uart_txc(char c);
extern void uart_txstr(char *c);
/* "hex2asc" Converts a 32-bit integer n into an ASCII string.

Maximum number of digits to display.  Conversion is controlled
by mode, as follows:
...
extern int hex2asc(void *n, int digs, int mode, char *s);
